...
public class TestaPontoFlutuante {
	public static void main(String[] args){
		...
		//divisão entre dois números inteiros, Java "forçará" um número inteiro como resultado
		
		double novaTentativa = 5/2;
		System.out.println(novaTentativa);	
		//Java irá ler primeiro o lado que vem antes da atribuição, ou seja, primeiro ele irá executar a divisão e depois ele tentará colocar o resultado em um double
