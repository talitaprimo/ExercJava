...
public class Fluxo5 {
	...
	private static void metodo1() {
		...
		metodo2();
		System.out.println("Fim do metodo1"); //Não é exibido pois saímos abruptamente do método
	}

	private static void metodo2() {
		System.out.println("Ini do metodo2");
		throw new ArithmeticException ("Ocorreu um erro!");  //Passamos para o construtor a mensagem "Ocorreu um erro!"
